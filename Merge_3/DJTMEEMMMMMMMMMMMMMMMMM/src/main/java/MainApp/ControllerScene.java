...
public class ControllerScene implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            Logger.getLogger(ControllerScene.class.getName()).log(Level.SEVERE, null, e);
        }
...
//MainApp.Game.StartScene
    ...
    public void Game(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(ControllerScene.class.getResource("/fxml/Start.fxml"));
